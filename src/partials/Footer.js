      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="mb-2">
              ...
              <Link to="/" className="inline-block" aria-label="Cruip">
                ...
                <img className="mx-auto" src={require('../images/travelBoostersBC.png').default} width="120" height="auto" alt="Hero" />
              </Link>
            </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            ...
            <li className="ml-4">
              <a href="https://www.instagram.com/travel.boosters/?hl=en" target="_blank" rel='noreferrer' className="flex justify-center items-center text-gray-900 hover:text-gray-600 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Instagram">
            ...
            <li className="ml-4">
              <a href="https://www.facebook.com/travelboosters" target="_blank" rel='noreferrer' className="flex justify-center items-center text-gray-900 hover:text-gray-600 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; 2022 Travel Boosters. All rights reserved.</div>
